...
// CHAT_IRID_V2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCHATIRIDV2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CCHATIRIDV2App

CCHATIRIDV2App::CCHATIRIDV2App()
{
...
// Единственный объект CCHATIRIDV2App

CCHATIRIDV2App theApp;


// Инициализация CCHATIRIDV2App

BOOL CCHATIRIDV2App::InitInstance()
{
